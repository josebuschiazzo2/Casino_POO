...
var juegoDeRuleta1 = new Ruleta_1.Ruleta("Color", 1, 1);
var fruits = new TresEnLinea_1.TresEnLinea("Tres en linea", 10, 2);
var juegos = new Array < string >
    juegos, _a = void 0, juegoDeDados1 = _a[0], obtenerNombre = _a[1];
(), juegoDeRuleta1.obtenerNombre(), fruits.obtenerNombre();
; // array de prueba
